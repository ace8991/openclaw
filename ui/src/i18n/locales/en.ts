...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    apiKeys: "Hot-reload provider credentials and default models.",
    ...
    coWork: "Collaborative project workspaces.",
    aceCode: "Integrated coding agent with file tree and terminal.",
    desktopCmd: "File browser, terminal, processes, system stats.",
    config: "Edit aceagent config (openclaw.json).",
