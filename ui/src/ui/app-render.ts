        ...
        ${
          state.tab === "chat"
            ? renderChat({
                ...
                liveViewOpen: state.browserLiveViewOpen,
                liveViewBusy: state.browserLiveViewBusy,
                liveViewConnected: state.browserLiveViewConnected,
                liveViewError: state.browserLiveViewError,
                liveViewImageUrl: state.browserLiveViewImageUrl,
                liveViewCurrentUrl: state.browserLiveViewCurrentUrl,
                liveViewFrameCount: state.browserLiveViewFrameCount,
                liveViewLastFrameAt: state.browserLiveViewLastFrameAt,
                liveViewFps: state.browserLiveViewFps,
                onToggleLiveView: () => state.handleToggleBrowserLiveView(),
